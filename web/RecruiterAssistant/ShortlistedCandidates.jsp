...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<%=application.getContextPath()%>/RecruiterAssistant/ShortlistedCandidates.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                    ...
                    buttons:
                            {
                                "Delete data": function() {
                                    $( this ).dialog( "close" );   
                                    location.href = "shortlisting.action?listSelectedData=" + listSelectedData;
                                },
                                Cancel: function() {
                                    $(this).dialog("close");
                                }
